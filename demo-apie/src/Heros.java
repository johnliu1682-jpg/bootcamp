public class Heros {
  private static final int[] [] PA = new int[3][10]; // 3 rows, 10 columns
  ...
  // ! static block
  // for assigning static variables
  // execute static block when there is a static variable
  static {
    // ! dictionary
  ...
  public static int getMAX_HP(int role, int level) {
    // Role = 0 (Warrior), Role = 1 (Archer), Role = 2 (Mage)
