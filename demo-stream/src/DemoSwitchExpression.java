public class DemoSwitchExpression {
  public static void main(String[] args) {
    ...
    // ! "Consumer", i.e. cannot return value, a void method
    switch (score) {
      case 80: // no case >= 80
        examGrade = 'B';
        break;
    ...
    for(Color color : colors) {
      ...
      // sum
      // ! Advantages: 
      // ! 1) enum + Switch Expression. Java helps check if all enum 
      // !    value has been considered + avoid duplicated enum value
    ...
    // ! if lamba logic contain 1 line of code, use "->" without yield
